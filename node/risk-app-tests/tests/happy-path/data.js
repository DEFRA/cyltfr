...
const data = [
  ...
  { premises: 26, postcode: 'BS20 6AQ', address: 24084542, outcome: RiskStatus.AtRisk,
  ...
  { premises: 101, postcode: 'LE4 5QD', address: 2465065006, outcome: RiskStatus.AtRisk,
  ...
  // riverAndSeaRisk: RiskLevel.High, surfaceWaterRisk: RiskLevel.Medium, reservoirRisk: true },
  { premises: 65, postcode: 'LE4 7SG', address: 2465089742, outcome: RiskStatus.AtRisk,
  ...
  { premises: 11, postcode: 'CV37 6YZ', address: 100070216073, outcome: RiskStatus.AtRisk,
  ...
  { premises: 'Mawby & King', postcode: 'LE2 7AY', address: 2465033045, outcome: RiskStatus.AtRisk,
  riverAndSeaRisk: RiskLevel.Medium, surfaceWaterRisk: RiskLevel.High, reservoirRisk: true },
  //  { postcode: 'POSTCODE', address: xx77079867, outcome: RiskStatus.AtRisk,
  ...
  { premises: 'THE STABLES', postcode: 'NN6 8PH', address: 28025584, outcome: RiskStatus.AtRisk,
  ...
  { premises: 6, postcode: 'W6 0PY', address: 34134541, outcome: RiskStatus.AtRisk,
  riverAndSeaRisk: RiskLevel.Low, surfaceWaterRisk: RiskLevel.High, reservoirRisk: true },
  { premises: 70, postcode: 'W6 0XL', address: 34002373, outcome: RiskStatus.AtRisk,
  ...
  { premises: 21, postcode: 'LE3 5JR', address: 2465038757, outcome: RiskStatus.AtRisk,
  riverAndSeaRisk: RiskLevel.Low, surfaceWaterRisk: RiskLevel.Medium, reservoirRisk: false },
  { premises: 2, postcode: 'NN6 6JP', address: 28030078, outcome: RiskStatus.AtRisk,
  riverAndSeaRisk: RiskLevel.Low, surfaceWaterRisk: RiskLevel.Low, reservoirRisk: true },
  { premises: 5, postcode: 'W6 0XY', address: 100021588829, outcome: RiskStatus.AtRisk,
  riverAndSeaRisk: RiskLevel.Low, surfaceWaterRisk: RiskLevel.Low, reservoirRisk: false },
  { premises: 28, postcode: 'TW9 3BH', address: 100022308486, outcome: RiskStatus.AtRisk,
  riverAndSeaRisk: RiskLevel.Low, surfaceWaterRisk: RiskLevel.VeryLow, reservoirRisk: true },
  { premises: 'KELSON HOUSE', postcode: 'E14 3JL', address: 6080809, outcome: RiskStatus.AtRisk,
  ...
  { premises: '27A', postcode: 'S6 4JP', address: 100052100616, outcome: RiskStatus.AtRisk,
  ...
  { premises: 42, postcode: 'SS8 7EH', address: 100090373928, outcome: RiskStatus.AtRisk,
  ...
  // Medium R&S Risk with variant SW Risk//
  { premises: 83, postcode: 'LE3 9RD', address: 2465041144, outcome: RiskStatus.AtRiskMonitor,
  riverAndSeaRisk: RiskLevel.Medium, surfaceWaterRisk: RiskLevel.High, reservoirRisk: true },
  ...
  // { postcode: 'POSTCODE', address: xx77079867, outcome: RiskStatus.AtRiskMonitor,
  // riverAndSeaRisk: RiskLevel.Medium, surfaceWaterRisk: RiskLevel.Low, reservoirRisk: true },
  { premises: 43, postcode: 'LE3 6AH', address: 2465040718, outcome: RiskStatus.AtRiskMonitor,
  riverAndSeaRisk: RiskLevel.Medium, surfaceWaterRisk: RiskLevel.High, reservoirRisk: false },
  //  { postcode: 'POSTCODE', address: xx77079867, outcome: RiskStatus.AtRiskMonitor,
  //  riverAndSeaRisk: RiskLevel.Medium, surfaceWaterRisk: RiskLevel.VeryLow, reservoirRisk: true },
  // { postcode: 'POSTCODE', address: xx77079867, outcome: RiskStatus.AtRiskMonitor,
  ...
  // Low R&S Risk with variant SW Risk//
  { premises: 73, postcode: 'LE3 9RD', address: 2465041139, outcome: RiskStatus.AtRiskMonitor,
  riverAndSeaRisk: RiskLevel.Low, surfaceWaterRisk: RiskLevel.High, reservoirRisk: true },
  //  { postcode: 'POSTCODE', address: xxx, outcome: RiskStatus.AtRiskMonitor,
  //  riverAndSeaRisk: RiskLevel.Low, surfaceWaterRisk: RiskLevel.High, reservoirRisk: false },
  //  { postcode: 'POSTCODE', address: XX77079867, outcome: RiskStatus.AtRiskMonitor,
  //  riverAndSeaRisk: RiskLevel.Low, surfaceWaterRisk: RiskLevel.Medium, reservoirRisk: true },
  { premises: 3, postcode: 'NN6 6LE', address: 28015435, outcome: RiskStatus.AtRiskMonitor,
  riverAndSeaRisk: RiskLevel.Low, surfaceWaterRisk: RiskLevel.Medium, reservoirRisk: false },
  ...
  //  riverAndSeaRisk: RiskLevel.VeryLow, surfaceWaterRisk: RiskLevel.Low, reservoirRisk: true },
  { premises: 6, postcode: 'BS20 6BQ', address: 24063776, outcome: RiskStatus.LowRisk,
  riverAndSeaRisk: RiskLevel.VeryLow, surfaceWaterRisk: RiskLevel.Low, reservoirRisk: false },
  { premises: 12, postcode: 'LE4 9BH', address: 2465119536, outcome: RiskStatus.LowRisk,
  riverAndSeaRisk: RiskLevel.Low, surfaceWaterRisk: RiskLevel.Low, reservoirRisk: true },
  //  { postcode: 'POSTCODE', address: xx77079867, outcome: RiskStatus.LowRisk,
  //  riverAndSeaRisk: RiskLevel.Low, surfaceWaterRisk: RiskLevel.Low, reservoirRisk: false },

  // Very low risk //
  { premises: 'Kenyon', postcode: 'WA3 7ED', address: 200000977803, outcome: RiskStatus.VeryLowRisk,
  riverAndSeaRisk: RiskLevel.VeryLow, surfaceWaterRisk: RiskLevel.VeryLow, reservoirRisk: false }
