          ...
          <fieldset id="root_features_${featureIndex}">
            <div class="form-group field field-object">
              <fieldset id="root_features_${featureIndex}_properties">
                ...
                <div class="hidden"><input type="hidden" id="root_features_${featureIndex}_properties_apply" value="llfa"></div>
                <div class="hidden"><input type="hidden" id="root_features_${featureIndex}_properties_riskOverride" value=""></div>
                <div class="form-group field field-string  govuk-form-group info"><label class="control-label"
                    for="root_features_${featureIndex}_properties_info">Report</label>
                  <p id="root_features_${featureIndex}_properties_info__description" class="field-description">The report text will display
                    to public users in this geometry.</p>
                  <div class="field-radio-group" id="root_features_${featureIndex}_properties_info">
                ...
                <div class="form-group field field-string  govuk-form-group start"><label class="control-label"
                    for="root_features_${featureIndex}_properties_start">Valid from<span class="required">*</span></label>
                  <p id="root_features_${featureIndex}_properties_start__description" class="field-description">For your reference and will
                    ...
                    <input name="features_${featureIndex}_properties_start" type="date" id="root_features_${featureIndex}_properties_start" class="govuk-input govuk-input--width-20 start-date"
                    autocomplete="off" required="" value="">
                </div>
                <div class="form-group field field-string  govuk-form-group end"><label class="control-label"
                    for="root_features_${featureIndex}_properties_end">Valid to<span class="required">*</span></label>
                  <p id="root_features_${featureIndex}_properties_end__description" class="field-description">For your reference and will
                  ...
                  <input name="features_${featureIndex}_properties_end" type="date" id="root_features_${featureIndex}_properties_end" class="govuk-input govuk-input--width-20 end-date"
                    autocomplete="off" required="" value="">
                </div>
              </fieldset>
            </div>
              ...
              <fieldset id="root_features_${featureIndex}_properties">
                ...
                <div class="form-group field field-string  govuk-form-group riskOverride">
                  ...
                  <div class="field-radio-group" id="root_features_${featureIndex}_properties_riskOverride">
                    <div class="radio "><label><span><input type="radio" name="features_${featureIndex}_properties_riskOverride" value="Do not override"><span>Do not override</span></span></label></div>
                    <div class="radio "><label><span><input type="radio" name="features_${featureIndex}_properties_riskOverride" value="Very low"><span>Very low</span></span></label></div>
                    <div class="radio "><label><span><input type="radio" name="features_${featureIndex}_properties_riskOverride" value="Low"><span>Low</span></span></label></div>
                    <div class="radio "><label><span><input type="radio" name="features_${featureIndex}_properties_riskOverride" value="Medium"><span>Medium</span></span></label></div>
                    <div class="radio "><label><span><input type="radio" name="features_${featureIndex}_properties_riskOverride" value="High"><span>High</span></span></label></div>
                  </div>
                </div>
                ...
                <div class="form-group field field-string  govuk-form-group start">
                  ...
                  <input name="features_${featureIndex}_properties_start" type="date" id="root_features_${featureIndex}_properties_start" class="start-date govuk-input govuk-input--width-20" autocomplete="off" required="">
                </div>
                <div class="form-group field field-string  govuk-form-group end">
                  ...
                  <input name="features_${featureIndex}_properties_end" type="date" id="root_features_${featureIndex}_properties_end" class="end-date govuk-input govuk-input--width-20" autocomplete="off" required="">
                </div>
              </fieldset>
            </div>
          </fieldset>
