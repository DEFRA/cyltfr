...
CREATE TABLE u_ltfri.flood_alert_area_bv_bng_valid TABLESPACE postgis_tables AS WITH
...
ALTER TABLE u_ltfri.flood_alert_area_bv_bng_valid ADD COLUMN ogc_fid SERIAL;
UPDATE u_ltfri.flood_alert_area_bv_bng_valid SET ogc_fid = DEFAULT;
ALTER TABLE u_ltfri.flood_alert_area_bv_bng_valid ADD PRIMARY KEY(ogc_fid);
...
CREATE TABLE u_ltfri.rof_reservoir_depth_bv_bng_valid TABLESPACE postgis_tables AS WITH
...
ALTER TABLE u_ltfri.rof_reservoir_depth_bv_bng_valid ADD COLUMN ogc_fid SERIAL;
UPDATE u_ltfri.rof_reservoir_depth_bv_bng_valid SET ogc_fid = DEFAULT;
ALTER TABLE u_ltfri.rof_reservoir_depth_bv_bng_valid ADD PRIMARY KEY(ogc_fid);

\echo 'ROF Reservoir Extent - MakeValid'

CREATE TABLE u_ltfri.rof_reservoir_extent_bv_bng_valid TABLESPACE postgis_tables AS WITH
...
ALTER TABLE u_ltfri.rof_reservoir_extent_bv_bng_valid ADD COLUMN ogc_fid SERIAL;
UPDATE u_ltfri.rof_reservoir_extent_bv_bng_valid SET ogc_fid = DEFAULT;
ALTER TABLE u_ltfri.rof_reservoir_extent_bv_bng_valid ADD PRIMARY KEY(ogc_fid);
...
CREATE TABLE u_ltfri.rof_reservoir_velocity_bv_bng_valid TABLESPACE postgis_tables AS WITH
...
ALTER TABLE u_ltfri.rof_reservoir_velocity_bv_bng_valid ADD COLUMN ogc_fid SERIAL;
UPDATE u_ltfri.rof_reservoir_velocity_bv_bng_valid SET ogc_fid = DEFAULT;
ALTER TABLE u_ltfri.rof_reservoir_velocity_bv_bng_valid ADD PRIMARY KEY(ogc_fid);
...
CREATE TABLE u_ltfri.ufmfsw_depth_1_in_1000_bv_bng_valid TABLESPACE postgis_tables AS WITH
...
ALTER TABLE u_ltfri.ufmfsw_depth_1_in_1000_bv_bng_valid ADD COLUMN ogc_fid SERIAL;
UPDATE u_ltfri.ufmfsw_depth_1_in_1000_bv_bng_valid SET ogc_fid = DEFAULT;
ALTER TABLE u_ltfri.ufmfsw_depth_1_in_1000_bv_bng_valid ADD PRIMARY KEY(ogc_fid);

\echo 'UFMFSW Depth 1 in 100 - MakeValid'

CREATE TABLE u_ltfri.ufmfsw_depth_1_in_100_bv_bng_valid TABLESPACE postgis_tables AS WITH
	make_valid("depth",pub_date,shape_length,shape_area,wkb_geometry) AS
		(SELECT "depth",pub_date,shape_length,shape_area,
...
ALTER TABLE u_ltfri.ufmfsw_depth_1_in_100_bv_bng_valid ADD COLUMN ogc_fid SERIAL;
UPDATE u_ltfri.ufmfsw_depth_1_in_100_bv_bng_valid SET ogc_fid = DEFAULT;
ALTER TABLE u_ltfri.ufmfsw_depth_1_in_100_bv_bng_valid ADD PRIMARY KEY(ogc_fid);

\echo 'UFMFSW Depth 1 in 30 - MakeValid'

CREATE TABLE u_ltfri.ufmfsw_depth_1_in_30_bv_bng_valid TABLESPACE postgis_tables AS WITH
	make_valid("depth",pub_date,shape_length,shape_area,wkb_geometry) AS
		(SELECT "depth",pub_date,shape_length,shape_area,
...
ALTER TABLE u_ltfri.ufmfsw_depth_1_in_30_bv_bng_valid ADD COLUMN ogc_fid SERIAL;
UPDATE u_ltfri.ufmfsw_depth_1_in_30_bv_bng_valid SET ogc_fid = DEFAULT;
ALTER TABLE u_ltfri.ufmfsw_depth_1_in_30_bv_bng_valid ADD PRIMARY KEY(ogc_fid);
...
CREATE TABLE u_ltfri.ufmfsw_extent_1_in_100_bv_bng_valid TABLESPACE postgis_tables AS WITH
	make_valid(pub_date,shape_length,shape_area,wkb_geometry) AS
		(SELECT pub_date,shape_length,shape_area,
...
ALTER TABLE u_ltfri.ufmfsw_extent_1_in_100_bv_bng_valid ADD COLUMN ogc_fid SERIAL;
UPDATE u_ltfri.ufmfsw_extent_1_in_100_bv_bng_valid SET ogc_fid = DEFAULT;
ALTER TABLE u_ltfri.ufmfsw_extent_1_in_100_bv_bng_valid ADD PRIMARY KEY(ogc_fid);

\echo 'UFMFSW Extent 1 in 30 - MakeValid'

CREATE TABLE u_ltfri.ufmfsw_extent_1_in_30_bv_bng_valid TABLESPACE postgis_tables AS WITH
	make_valid(pub_date,shape_length,shape_area,wkb_geometry) AS
		(SELECT pub_date,shape_length,shape_area,
...
ALTER TABLE u_ltfri.ufmfsw_extent_1_in_30_bv_bng_valid ADD COLUMN ogc_fid SERIAL;
UPDATE u_ltfri.ufmfsw_extent_1_in_30_bv_bng_valid SET ogc_fid = DEFAULT;
ALTER TABLE u_ltfri.ufmfsw_extent_1_in_30_bv_bng_valid ADD PRIMARY KEY(ogc_fid);
...
CREATE TABLE u_ltfri.ufmfsw_flow_direction_1_in_100_bv_bng_valid TABLESPACE postgis_tables AS WITH
	make_valid(flowdir,pub_date,wkb_geometry) AS
		(SELECT flowdir,pub_date,
...
ALTER TABLE u_ltfri.ufmfsw_flow_direction_1_in_100_bv_bng_valid ADD COLUMN ogc_fid SERIAL;
UPDATE u_ltfri.ufmfsw_flow_direction_1_in_100_bv_bng_valid SET ogc_fid = DEFAULT;
ALTER TABLE u_ltfri.ufmfsw_flow_direction_1_in_100_bv_bng_valid ADD PRIMARY KEY(ogc_fid);

\echo 'UFMFSW Flow Direction 1 in 30 - MakeValid'

CREATE TABLE u_ltfri.ufmfsw_flow_direction_1_in_30_bv_bng_valid TABLESPACE postgis_tables AS WITH
	make_valid(flowdir,pub_date,wkb_geometry) AS
		(SELECT flowdir,pub_date,
...
ALTER TABLE u_ltfri.ufmfsw_flow_direction_1_in_30_bv_bng_valid ADD COLUMN ogc_fid SERIAL;
UPDATE u_ltfri.ufmfsw_flow_direction_1_in_30_bv_bng_valid SET ogc_fid = DEFAULT;
ALTER TABLE u_ltfri.ufmfsw_flow_direction_1_in_30_bv_bng_valid ADD PRIMARY KEY(ogc_fid);

\echo 'UFMFSW Suitability - MakeValid'

CREATE TABLE u_ltfri.ufmfsw_suitability_bv_bng_valid TABLESPACE postgis_tables AS WITH    
...
ALTER TABLE u_ltfri.ufmfsw_suitability_bv_bng_valid ADD COLUMN ogc_fid SERIAL;
UPDATE u_ltfri.ufmfsw_suitability_bv_bng_valid SET ogc_fid = DEFAULT;
ALTER TABLE u_ltfri.ufmfsw_suitability_bv_bng_valid ADD PRIMARY KEY(ogc_fid);

\echo 'UFMFSW Velocity 1 in 1000 - MakeValid'

CREATE TABLE u_ltfri.ufmfsw_velocity_1_in_1000_bv_bng_valid TABLESPACE postgis_tables AS WITH
...
ALTER TABLE u_ltfri.ufmfsw_velocity_1_in_1000_bv_bng_valid ADD COLUMN ogc_fid SERIAL;
UPDATE u_ltfri.ufmfsw_velocity_1_in_1000_bv_bng_valid SET ogc_fid = DEFAULT;
ALTER TABLE u_ltfri.ufmfsw_velocity_1_in_1000_bv_bng_valid ADD PRIMARY KEY(ogc_fid);

\echo 'UFMFSW Velocity 1 in 100 - MakeValid'

CREATE TABLE u_ltfri.ufmfsw_velocity_1_in_100_bv_bng_valid TABLESPACE postgis_tables AS WITH
	make_valid(velocity,pub_date,shape_length,shape_area,wkb_geometry) AS
		(SELECT velocity,pub_date,shape_length,shape_area,
...
ALTER TABLE u_ltfri.ufmfsw_velocity_1_in_100_bv_bng_valid ADD COLUMN ogc_fid SERIAL;
UPDATE u_ltfri.ufmfsw_velocity_1_in_100_bv_bng_valid SET ogc_fid = DEFAULT;
ALTER TABLE u_ltfri.ufmfsw_velocity_1_in_100_bv_bng_valid ADD PRIMARY KEY(ogc_fid);

\echo 'UFMFSW Velocity 1 in 30 - MakeValid'

CREATE TABLE u_ltfri.ufmfsw_velocity_1_in_30_bv_bng_valid TABLESPACE postgis_tables AS WITH
	make_valid(velocity,pub_date,shape_length,shape_area,wkb_geometry) AS
		(SELECT velocity,pub_date,shape_length,shape_area,
...
ALTER TABLE u_ltfri.ufmfsw_velocity_1_in_30_bv_bng_valid ADD COLUMN ogc_fid SERIAL;
UPDATE u_ltfri.ufmfsw_velocity_1_in_30_bv_bng_valid SET ogc_fid = DEFAULT;
ALTER TABLE u_ltfri.ufmfsw_velocity_1_in_30_bv_bng_valid ADD PRIMARY KEY(ogc_fid);