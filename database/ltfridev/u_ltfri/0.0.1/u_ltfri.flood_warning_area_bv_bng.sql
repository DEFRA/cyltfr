-- Table: u_ltfri.flood_warning_area_bv_bng

-- DROP SEQUENCE flood_warning_area_bv_bng_ogc_fid_seq;
...
CREATE SEQUENCE flood_warning_area_bv_bng_ogc_fid_seq
  ...
  START 22736
  CACHE 1;
ALTER TABLE flood_warning_area_bv_bng_ogc_fid_seq
  OWNER TO u_ltfri;


-- DROP TABLE u_ltfri.flood_warning_area_bv_bng;

CREATE TABLE u_ltfri.flood_warning_area_bv_bng
(
    ogc_fid integer NOT NULL DEFAULT nextval('u_ltfri.flood_warning_area_bv_bng_ogc_fid_seq'::regclass),
    wkb_geometry postgis."geometry(MultiPolygon,27700)",
    ...
    CONSTRAINT flood_warning_area_bv_bng_pkey PRIMARY KEY (ogc_fid)
...
ALTER TABLE u_ltfri.flood_warning_area_bv_bng
    OWNER to u_ltfri;

-- Index: flood_warning_area_bv_bng_wkb_geometry_geom_idx

-- DROP INDEX u_ltfri.flood_warning_area_bv_bng_wkb_geometry_geom_idx;

CREATE INDEX flood_warning_area_bv_bng_wkb_geometry_geom_idx
    ON u_ltfri.flood_warning_area_bv_bng USING gist
    (wkb_geometry)
