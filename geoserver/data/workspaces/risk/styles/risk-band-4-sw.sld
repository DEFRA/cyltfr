    ...
    <!-- Styles can have names, titles and abstracts -->
      ...
      <!-- A FeatureTypeStyle for rendering polygons -->
        ...
        <ogc:Filter>
          ...
          <PolygonSymbolizer>
            <Fill>
              <CssParameter name="fill">#C4C0C0</CssParameter>
            </Fill>
          </PolygonSymbolizer>
        </Rule>
      </FeatureTypeStyle>
        ...
        <ogc:Filter>
          ...
          <PolygonSymbolizer>
            <Fill>
              <CssParameter name="fill">#FFBFC9</CssParameter>
            </Fill>
          </PolygonSymbolizer>
        </Rule>
      </FeatureTypeStyle>
        ...
        <ogc:Filter> 
          ...
          <PolygonSymbolizer>
            <Fill>
              <CssParameter name="fill">#E6772E</CssParameter>
            </Fill>
          </PolygonSymbolizer>
        </Rule>
       </FeatureTypeStyle>
      ...
      <FeatureTypeStyle>
        ...
        <ogc:Filter>         
          ...
          <PolygonSymbolizer>
            <Fill>
              <CssParameter name="fill">#99004D</CssParameter>
            </Fill>
          </PolygonSymbolizer>
        </Rule>
       </FeatureTypeStyle>
